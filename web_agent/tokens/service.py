...
from web_agent.tokens.custom_pricing import CUSTOM_MODEL_PRICING
from web_agent.tokens.mappings import MODEL_TO_LITELLM
from web_agent.tokens.views import (
	CachedPricingData,
	ModelPricing,
	ModelUsageStats,
	ModelUsageTokens,
...
class TokenCost:
	...
	CACHE_DIR_NAME = 'web_agent/token_cost'
	CACHE_DURATION = timedelta(days=1)
	PRICING_URL = 'https://raw.githubusercontent.com/BerriAI/litellm/main/model_prices_and_context_window.json'

	def __init__(self, include_cost: bool = False):
		self.include_cost = include_cost or os.getenv('web_agent_CALCULATE_COST', 'false').lower() == 'true'
