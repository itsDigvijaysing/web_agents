"""
Cloud sync service for sending events to the web agent cloud.
"""
...
from web_agent.sync.auth import TEMP_USER_ID, DeviceAuthClient

logger = logging.getLogger(__name__)


class CloudSync:
	"""Service for syncing events to the web agent cloud"""
	...
	def __init__(self, base_url: str | None = None, allow_session_events_for_auth: bool = False):
		...
		self.enabled = CONFIG.web_agent_CLOUD_SYNC
	...
	# 		wal_path = CONFIG.web_agent_CONFIG_DIR / 'events' / f'{session_id}.jsonl'
