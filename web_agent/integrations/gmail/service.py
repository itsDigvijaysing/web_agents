"""
Gmail API Service for web agent
...
class GmailService:
	...
	def __init__(
		...
		Args:
		    ...
		    config_dir: Directory to store config files (defaults to web-agent config directory)
		    access_token: Direct access token (skips file-based auth if provided)
		"""
		# Set up configuration directory using web-agent's config system
