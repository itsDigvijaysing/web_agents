# @file purpose: Observability module for web-agent that handles optional lmnr integration with debug mode support
"""
Observability module for web-agent
...
try:
	...
	if os.environ.get('web_agent_VERBOSE_OBSERVABILITY', 'false').lower() == 'true':
...
def observe_debug(
	...
	**kwargs: Any,
	...
	- web_agent_DEBUG environment variable set to 1/true/yes/on
