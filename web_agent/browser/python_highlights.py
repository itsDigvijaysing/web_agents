...
from web_agent.dom.views import DOMSelectorMap, EnhancedDOMTreeNode
from web_agent.observability import observe_debug
from web_agent.utils import time_execution_async
...
async def create_highlighted_screenshot_async(
	...
	filename = os.getenv('web_agent_SCREENSHOT_FILE')
	if filename:
