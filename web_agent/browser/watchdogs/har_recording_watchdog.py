"""HAR Recording Watchdog for web-agent sessions.
...
from web_agent.browser.events import BrowserConnectedEvent, BrowserStopEvent
...
class HarRecordingWatchdog(BaseWatchdog):
	...
	async def _write_har(self) -> None:
		...
		try:
			bu_version = importlib_metadata.version('web-agent')
		except Exception:
		...
		har_obj = {
			'log': {
				'version': '1.2',
				'creator': {'name': 'web-agent', 'version': bu_version},
