...
from web_agent.utils import create_task_with_error_handling, time_execution_async

if TYPE_CHECKING:
	from web_agent.browser.views import BrowserStateSummary, NetworkRequest, PageInfo, PaginationButton
...
class DOMWatchdog(BaseWatchdog):
	...
	async def _get_pending_network_requests(self) -> list['NetworkRequest']:
		...
		"""
		from web_agent.browser.views import NetworkRequest
...
"""
	...
	async def on_BrowserStateRequestEvent(self, event: BrowserStateRequestEvent) -> 'BrowserStateSummary':
		...
		"""
		from web_agent.browser.views import BrowserStateSummary, PageInfo
	...
	def _detect_pagination_buttons(self, selector_map: dict[int, EnhancedDOMTreeNode]) -> list['PaginationButton']:
		...
		"""
		from web_agent.browser.views import PaginationButton
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from web_agent.browser.views import PageInfo
