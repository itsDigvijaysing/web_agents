"""
Enhanced snapshot processing for web-agent DOM tree extraction.
...
from web_agent.dom.views import DOMRect, EnhancedSnapshotNode
...
def build_snapshot_lookup(
	...
	logger = logging.getLogger('web_agent.dom.enhanced_snapshot')
