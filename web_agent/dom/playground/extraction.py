...
from web_agent.agent.prompts import AgentMessagePrompt
...
from web_agent.dom.views import DEFAULT_INCLUDE_ATTRIBUTES
...
async def test_focus_vs_all_elements():
	...
	sample_websites = [
		'https://web-agent.github.io/stress-tests/challenges/iframe-inception-level2.html',
		'https://www.google.com/travel/flights',
		'https://v0-simple-ui-test-site.vercel.app',
		'https://web-agent.github.io/stress-tests/challenges/iframe-inception-level1.html',
		'https://web-agent.github.io/stress-tests/challenges/angular-form.html',
		'https://www.google.com/travel/flights',
	...
	# Show startup info
	print('\n🌐 web-agent DOM EXTRACTION TESTER')
