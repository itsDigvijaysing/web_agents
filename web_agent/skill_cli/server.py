...
logger = logging.getLogger('web_agent.skill_cli.server')
...
class SessionServer:
	...
	def __init__(
		...
		from web_agent.skill_cli.sessions import SessionRegistry
	...
	async def dispatch(self, request: dict) -> dict:
		...
		try:
			...
			from web_agent.skill_cli.commands import agent, browser, python_exec, session
	...
	async def shutdown(self) -> None:
		...
		# Clean up files
		from web_agent.skill_cli.utils import cleanup_session_files

		cleanup_session_files(self.session_name)

	async def run(self) -> None:
		"""Run the server."""
		from web_agent.skill_cli.utils import get_lock_path, get_pid_path, get_socket_path
...
def main() -> None:
	...
	parser = argparse.ArgumentParser(description='web-agent session server')
