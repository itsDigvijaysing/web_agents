...
from web_agent.skill_cli.python_session import PythonSession
...
async def create_browser_session(
	...
	- remote: web-agent Cloud (requires API key)
	...
	if mode == 'chromium':
		...
		from web_agent.skill_cli.utils import find_chrome_executable, get_chrome_profile_path
