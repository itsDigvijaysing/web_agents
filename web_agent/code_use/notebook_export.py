...
from web_agent.code_use import create_namespace
...
print("web-agent environment initialized!")
...
def session_to_python_script(agent: CodeAgent) -> str:
	...
	lines.append('# Generated from web-agent code-use session\n')
	lines.append('import asyncio\n')
	lines.append('import json\n')
	lines.append('from web_agent import BrowserSession\n')
	lines.append('from web_agent.code_use import create_namespace\n\n')
