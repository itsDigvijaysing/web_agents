...
class ActionRegistry(BaseModel):
	...
	def _match_domains(domains: list[str] | None, url: str) -> bool:
		...
		from web_agent.utils import match_url_with_domain_pattern
...
class SpecialActionParameters(BaseModel):
	...
	# web-agent code doesn't use this at all, we just pass it down to your actions for convenience
	context: Any | None = None

	# web-agent session object, can be used to create new tabs, navigate, access CDP
