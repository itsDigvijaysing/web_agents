...
from web_agent.llm import ChatAnthropic, ChatGoogle, ChatGroq, ChatOpenAI, ChatOpenRouter
...
class TestChatModels:
	...
	def oci_raw_chat(self):
		...
		if not OCI_MODELS_AVAILABLE:
			pytest.skip('OCI models not available - install with pip install "web-agent[oci]"')
