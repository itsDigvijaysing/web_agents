"""
OCI Raw API chat model integration for web-agent.
...
from web_agent.llm.schema import SchemaOptimizer
...
class ChatOCIRaw(BaseChatModel):
	"""
	A direct OCI Raw API integration for web-agent that bypasses Langchain.

	This class provides a web-agent compatible interface for OCI GenAI models
...
"""
				...
				from web_agent.llm.messages import SystemMessage
