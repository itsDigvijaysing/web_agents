...
# Add parent directory to path to import web_agent modules
...
from web_agent.browser.events import BrowserStateRequestEvent
	...
	actions = [
		...
		"""
		{
			...
			"action": [
				{
					"navigate": {
						"url": "https://web-agent.github.io/stress-tests/challenges/iframe-inception-level1.html",
						"new_tab": false
					}
				}
			]
