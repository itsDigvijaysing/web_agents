...
from web_agent.agent.variable_detector import (
...
from web_agent.agent.views import DetectedVariable
from web_agent.dom.views import DOMInteractedElement, NodeType
