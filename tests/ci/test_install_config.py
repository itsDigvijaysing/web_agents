...
class TestInstallConfig:
	"""Tests for web_agent.skill_cli.install_config module."""
	...
	def temp_config_dir(self, tmp_path: Path):
		...
		with patch('web_agent.skill_cli.install_config.CONFIG_PATH', config_path):
			yield config_path

	def test_get_config_default_all_modes(self, temp_config_dir: Path):
		"""If no config file, all modes available (pip install users)."""
		from web_agent.skill_cli.install_config import get_config
	...
	def test_save_config_creates_file(self, temp_config_dir: Path):
		...
		from web_agent.skill_cli.install_config import save_config
	...
	def test_save_config_creates_parent_directories(self, tmp_path: Path):
		...
		with patch('web_agent.skill_cli.install_config.CONFIG_PATH', nested_path):
	...
	def test_is_mode_available_remote_only(self, temp_config_dir: Path):
		...
		from web_agent.skill_cli.install_config import is_mode_available, save_config
	...
	def test_get_default_mode(self, temp_config_dir: Path):
		...
		from web_agent.skill_cli.install_config import get_default_mode, save_config
	...
	def test_get_available_modes(self, temp_config_dir: Path):
		...
		from web_agent.skill_cli.install_config import get_available_modes, save_config
	...
	def test_get_mode_unavailable_error_message(self, temp_config_dir: Path):
		...
		from web_agent.skill_cli.install_config import get_mode_unavailable_error, save_config
	...
	def test_no_config_file_means_all_modes_available(self, temp_config_dir: Path):
		...
		from web_agent.skill_cli.install_config import (
			get_available_modes,
			get_default_mode,
			is_mode_available,
		)
