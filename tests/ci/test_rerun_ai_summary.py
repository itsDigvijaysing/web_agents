...
from web_agent.agent.views import ActionResult, AgentHistory, AgentHistoryList, RerunSummaryAction, StepMetadata
from web_agent.browser.views import BrowserStateHistory
from web_agent.dom.views import DOMRect, NodeType
...
async def test_rerun_cleanup_on_failure(httpserver):
	...
	"""
	from web_agent.dom.views import DOMInteractedElement
