...
class TestBrowserContext:
	...
	# 	# Navigate to a test page
	# 	from web_agent.browser.events import NavigateToUrlEvent; event = browser_session.event_bus.dispatch(NavigateToUrlEvent(url=f'{base_url}/')
	...
	#         element.setAttribute('web-agentr-highlight-id', 'playwright-highlight-1');
	#     """)
	...
	# 		"document.querySelector('h1').hasAttribute('web-agentr-highlight-id')"
	# 	)
	# 	assert not attribute_exists, 'web-agentr-highlight-id attribute should be removed'
