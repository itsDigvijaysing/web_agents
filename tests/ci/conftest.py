"""
Pytest configuration for web-agent CI tests.
...
from web_agent.agent.views import AgentOutput
...
def setup_test_environment():
	...
	config_dir = tempfile.mkdtemp(prefix='webagent_tests_')

	original_env = {}
	test_env_vars = {
		'SKIP_LLM_API_KEY_VERIFICATION': 'true',
		'ANONYMIZED_TELEMETRY': 'false',
		'web_agent_CLOUD_SYNC': 'true',
		'web_agent_CLOUD_API_URL': 'http://placeholder-will-be-replaced-by-specific-test-fixtures',
		'web_agent_CLOUD_UI_URL': 'http://placeholder-will-be-replaced-by-specific-test-fixtures',
		# Don't set web_agent_CONFIG_DIR anymore - let it use the default ~/.config/webagent
		# This way extensions will be cached in ~/.config/webagent/extensions
	}
