...
**Phase 2 (not started):** retrieval-augmented context injection (seam: `Agent._prepare_context`), trajectory retrieval (seam: `AgentHistoryList` + `save_history`/`load_and_rerun`), knowledge augmentation. Design this properly (brainstorm first, using the Agent S / Explorer / WebRover references) before implementing.
