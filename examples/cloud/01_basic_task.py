"""
Cloud Example 1: Your First web agent Cloud Task
==================================================

This example demonstrates the most basic web agent Cloud functionality:
...
def main():
	...
	print('🚀 web agent Cloud - Basic Task Example')
	print('=' * 50)
