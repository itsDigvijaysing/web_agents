# web agent Cloud Examples 🚀

Welcome to the web agent Cloud examples! This folder contains progressively complex examples to help you get started with the web agent Cloud API quickly and efficiently.

## 📋 Prerequisites

1. **API Key**: Get your API key from [cloud.web-agent.com](https://cloud.web-agent.com/new-api-key)
...
export web_agent_API_KEY="your_api_key_here"
export web_agent_BASE_URL="https://api.web-agent.com/api/v1"  # Optional
export web_agent_TIMEOUT="30"  # Optional: request timeout in seconds
...
- [Cloud API Documentation](https://docs.web-agent.com/cloud)
- [API Reference](https://docs.web-agent.com/api-reference)
- [Pricing](https://cloud.web-agent.com/billing)
- [Discord Community](https://link.web-agent.com/discord)
...
- 📧 Email: support@web-agent.com
- 💬 Discord: [Join our community](https://link.web-agent.com/discord)
- 📖 Docs: <https://docs.web-agent.com>
