...
Contact us if you need help with this: support@web-agent.com
"""
...
from web_agent import Agent, BrowserProfile, ChatAzureOpenAI
...
browser_profile = BrowserProfile(allowed_domains=['*google.com', 'web-agent.com'], enable_default_extensions=False)
...
sensitive_data = {'company_name': 'web-agent'}
