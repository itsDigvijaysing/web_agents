#!/usr/bin/env python3
"""
News monitoring agent with web-agent + Gemini Flash.
...
parser = argparse.ArgumentParser(description='News extractor using web-agent + Gemini')
...
from web_agent import Agent, BrowserSession, ChatGoogle
