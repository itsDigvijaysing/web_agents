...
[!WARNING]
This demo requires web-agent v0.7.7+.

https://web-agent.github.io/media/demos/msg_use.mp4
...
Make sure the newest version of web-agent is installed:
```bash
pip install -U web-agent
```
...
```bash
git clone https://github.com/web-agent/web-agent.git
cd web-agent/examples/apps/msg-use
```
