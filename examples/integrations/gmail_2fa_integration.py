...
3. Save credentials as ~/.config/webagent/gmail_credentials.json
...
from web_agent import Agent, ChatOpenAI, Tools
from web_agent.config import CONFIG
from web_agent.integrations.gmail import GmailService, register_gmail_actions
...
class GmailGrantManager:
	...
	def __init__(self):
		self.config_dir = CONFIG.web_agent_CONFIG_DIR
