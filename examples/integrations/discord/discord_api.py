...
class DiscordBot(commands.Bot):
	"""Discord bot implementation for web-agent tasks.
	...
	async def run_agent(self, task: str) -> str:
		try:
			...
			if agent_message is None:
				agent_message = 'Oops! Something went wrong while running web-agent.'

			return agent_message

		except Exception as e:
			raise Exception(f'web-agent task failed: {str(e)}')
