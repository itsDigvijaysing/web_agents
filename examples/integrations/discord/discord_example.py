...
7. Write e.g. "/bu what's the weather in Tokyo?" to start a web-agent task and get a response inside the Discord channel.
"""
...
from web_agent.browser import BrowserProfile
from web_agent.llm import ChatGoogle
...
bot = DiscordBot(
	...
	prefix='$bu',  # optional; prefix of messages to trigger web-agent, defaults to "$bu"
