...
from web_agent import ActionResult, Agent, Browser, ChatOpenAI, Tools
...
**SETUP**
How to setup 1Password with web agent
...
async def main():
	...
	op_client = await Client.authenticate(auth=token, integration_name='web agent Secure Login', integration_version='v1.0.0')
