"""Example of using sandbox execution with web-agent Agent
...
To run this example:
1. Set your web_agent_API_KEY environment variable
...
from web_agent import Browser, Chatwebagent, sandbox
...
async def main():
	...
	if not os.getenv('web_agent_API_KEY'):
		print('❌ Please set web_agent_API_KEY environment variable')
		return
