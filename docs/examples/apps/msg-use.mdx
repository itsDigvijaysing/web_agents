...
<video
  ...
  src="https://web-agent.github.io/media/demos/msg_use.mp4">
</video>
...
Full implementation: [https://github.com/web-agent/web-agent/tree/main/examples/apps/msg-use](https://github.com/web-agent/web-agent/tree/main/examples/apps/msg-use)
