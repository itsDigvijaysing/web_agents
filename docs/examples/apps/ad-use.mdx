...
<Note>
This demo requires web-agent v0.7.6+.
</Note>
...
Full implementation: [https://github.com/web-agent/web-agent/tree/main/examples/apps/ad-use](https://github.com/web-agent/web-agent/tree/main/examples/apps/ad-use)
