...
<video
  ...
  src="https://web-agent.github.io/media/demos/news_use.mp4">
</video>
...
Full implementation: [https://github.com/web-agent/web-agent/tree/main/examples/apps/news-use](https://github.com/web-agent/web-agent/tree/main/examples/apps/news-use)
