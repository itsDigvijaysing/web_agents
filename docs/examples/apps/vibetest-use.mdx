...
description: "Run multi-agent web-agent tests to catch UI bugs, broken links, and accessibility issues before they ship."
icon: "bug"
mode: "wide"
---

<Note>
Requires **web-agent&nbsp; < v0.5.0** and Playwright Chromium. Currently getting an update to v0.7.6+. 
</Note>
...
1. Launches multiple headless (or visible) web-agent agents in parallel
...
# 1. Clone repo 
git clone https://github.com/web-agent/vibetest-use.git
cd vibetest-use
...
## Basic Prompts
```
> Vibetest my website with 5 agents: web-agent.com
...
Full implementation: [https://github.com/web-agent/vibetest-use](https://github.com/web-agent/vibetest-use)
