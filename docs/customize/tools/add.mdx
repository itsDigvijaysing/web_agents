...
```python
from web_agent import Tools, Agent, ActionResult, BrowserSession
...
- See `web_agent/actor/element.py` for more methods
...
**[Playwright Integration Example](https://github.com/web-agent/web-agent/blob/main/examples/browser/playwright_integration.py)**

This shows how to create custom actions that use Playwright's precise browser automation alongside web-agent.
...
```python
from web_agent import Tools, ActionResult, Browser
