...
- `skills` (or `skill_ids`): List of skill IDs to load (e.g., `['skill-uuid']` or `['*']` for all). Requires `web_agent_API_KEY`. <a href = "../skills/basics">Docs</a>
