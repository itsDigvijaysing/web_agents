...
```python
import asyncio
from web_agent import CodeAgent
...
<Note>
CodeAgent currently only works with [Chatwebagent](/supported-models) which is optimized for this use case.
Don't have one? We give you $10 to try it out [here](https://cloud.web-agent.com/new-api-key).
</Note>
