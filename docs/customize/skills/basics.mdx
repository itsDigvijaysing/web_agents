...
To learn more visit [Skills - Concepts](https://docs.cloud.web-agent.com/concepts/skills).


## Quick Example


Load `['*']` for all skills or specific skill IDs from [cloud.web-agent.com/skills](https://cloud.web-agent.com/skills).
...
```bash .env
web_agent_API_KEY=your-api-key
```

<Note>
Get your API key on [cloud](https://cloud.web-agent.com/new-api-key) - new signups get \$10 free.
</Note>
...
Browse and create skills at [cloud.web-agent.com/skills](https://cloud.web-agent.com/skills).
