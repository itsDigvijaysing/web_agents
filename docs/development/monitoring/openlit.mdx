---
title: "OpenLIT"
description: "Complete observability for web agent with OpenLIT tracing"
icon: "chart-line"
mode: "wide"
---
...
web agent has native integration with [OpenLIT](https://github.com/openlit/openlit) - an open-source opentelemetry-native platform that provides complete, granular traces for every task your web-agent agent performs—from high-level agent invocations down to individual browser actions.

Read more about OpenLIT in the [OpenLIT docs](https://docs.openlit.io).

## Setup

Install OpenLIT alongside web agent:

```bash
pip install openlit web-agent
```
